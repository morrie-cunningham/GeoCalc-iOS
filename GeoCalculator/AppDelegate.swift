...
import GooglePlaces
let GOOGLE_PLACES_API_KEY = "AIzaSyAGx_rOt6jiqeivd59lYZYYcl-yPWOaDxs"

let FOREGROUND_COLOR = UIColor.init(colorLiteralRed:0.000, green:0.157, blue:0.716,
                                alpha:1.00)  // DARK BLUE
let BACKGROUND_COLOR = UIColor.init(colorLiteralRed:1.000, green:0.500, blue:0.000,
                                alpha:1.00) // Orange
